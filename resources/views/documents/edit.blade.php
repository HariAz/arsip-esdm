        ...
        <form method="POST" action="{{ route('documents.update', $document) }}">
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    value="{{ old('document_classification_code', $document->document_classification_code) }}"
                ...
                <small class="text-muted" style="font-size:11px;">
                    Kode pengelompokan berdasarkan isi/subjek sesuai standar internal instansi.
                </small>
            </div>
