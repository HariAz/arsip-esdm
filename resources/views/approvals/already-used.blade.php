...
<div class="card-custom">
  <div class="icon">🔒</div>
  <h2>Link Sudah Digunakan</h2>
  <p>
    Link persetujuan ini sudah pernah digunakan sebelumnya dan tidak dapat dipakai lagi.
    Setiap link hanya berlaku untuk satu kali penggunaan.
  </p>
