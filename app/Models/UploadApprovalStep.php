...
class UploadApprovalStep extends Model
{
    protected $fillable = [
        'upload_approval_id', 'step_order', 'approver_name', 'approver_email',
    ...
    public function uploadApproval(): BelongsTo
    {
        return $this->belongsTo(UploadApproval::class);
    }
